...
// Sun Mar 22 19:20:30 2020 by ROOT version 6.18/04
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Float_t xx[5][2],yy[5][2],xz[5],yz[5];//x,y,0-measured,1-fitted

   Int_t flag;

   Float_t ta[5];

   Float_t dx[5],dy[5];//residual
   Double_t tx,ty;//target position
   Float_t c2nx,c2ny;//chi2/ndf for xfit,yfit
